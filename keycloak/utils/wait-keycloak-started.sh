...
=======
/opt/jboss/keycloak/bin/kcadm.sh create realms -s realm=horbus -s enabled=true -o
/opt/jboss/keycloak/bin/kcadm.sh create clients -r horbus -f /var/tmp/frontend.json
/opt/jboss/keycloak/bin/kcadm.sh create clients -r horbus -f /var/tmp/backend.json
/opt/jboss/keycloak/bin/kcadm.sh create partialImport -r horbus -s ifResourceExists=OVERWRITE -f /var/tmp/users.json
echo "server running ...." >> ${LOGFILE}


>>>>>>> 01e80d12bc6aa146c71d9d20b5d066384abc5928

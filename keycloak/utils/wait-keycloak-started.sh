...
/opt/jboss/keycloak/bin/kcadm.sh create realms -s realm=horarbus -s enabled=true -o
/opt/jboss/keycloak/bin/kcadm.sh create clients -r horarbus -f /var/tmp/frontend.json
/opt/jboss/keycloak/bin/kcadm.sh create clients -r horarbus -f /var/tmp/backend.json
/opt/jboss/keycloak/bin/kcadm.sh create partialImport -r horarbus -s ifResourceExists=OVERWRITE -f /var/tmp/users.json
